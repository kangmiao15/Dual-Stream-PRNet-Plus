import sys
# m = sys.path.remove('/media/ubuntu/DISK2/code/deformable-kernels/deformable_kernels/ops/deform_kernel')
# sys.path.append("/media/ubuntu/DISK2/code/DIR-Lab-data-process/RegNet/functions")
import setting.setting_utils as su
import SimpleITK as sitk
import image_processing as ip

def resampling_setting():
    resampling(data='DIR-Lab_4D', spacing=[1, 1, 2.5], requested_im_list=['Im'])
    ...
    # resampling(data='DIR-Lab_COPD', spacing=[1, 1, 1], requested_im_list=['Im'])
